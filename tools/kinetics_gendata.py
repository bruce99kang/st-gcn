...
if __name__ == '__main__':
    ...
    parser.add_argument(
        '--data_path', default='/home/sims/Downloads/')
    parser.add_argument(
        '--out_folder', default='/home/sims/Downloads/')
    arg = parser.parse_args()

    part = ['train', 'val']
    for p in part:
        data_path = '{}/{}'.format(arg.data_path, p)
        label_path = '{}/pose_{}_label.json'.format(arg.data_path, p)
        data_out_path = '{}/pose_{}_data.npy'.format(arg.out_folder, p)
        label_out_path = '{}/pose_{}_label.pkl'.format(arg.out_folder, p)
